...
public class AuthFilterConfig implements WebMvcConfigurer {
    ...
    public class AuthInterceptor implements HandlerInterceptor {
         ...
         * @throws Exception
         */
        public boolean authCheck(HttpServletRequest request, String stoken, int appId, String fileId) throws Exception {
    		...
    		if (r == null) {
    			throw new DefineException(ResponseCodeConstants.FORBID_ACCESS_ERROR, "The token is a forgery!");
    		}
    		if (!r.isPass()) {
