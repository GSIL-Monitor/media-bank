...
public class SecurityToken {
  ...
  public SecurityToken(String securityToken) {
    ...
    try {
      ...
      throw new DefineException("safeUrlDecode exception", e);
    }
    this.signature = s[2];
  ...
  /**
   * 需要签名的参数名称格式化串 如 指定可以访问action1； 限定 参数Param1=1，Param2=2，Param3=3 那么fomatParamNameString 可以按照如下格式拼装
   * fomatParamNameString： Param1,Param2,Param2 fomatParamString: 1\n2\n3
   */
